 ...
 * @since v4.6
 */
public class KaiX1ServerInfoProxy implements ServerInfoProxy
{
    private final String appId;
    private final String instanceId;

    public KaiX1ServerInfoProxy(VcaInfo vcaInfo)
    {
    ...
    {
        return new File(Program.KAI_X1.getProgramFolder());
    }
