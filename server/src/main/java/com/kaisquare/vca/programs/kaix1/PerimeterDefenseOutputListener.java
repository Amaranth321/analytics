 ...
 * @since v4.5
 */
class PerimeterDefenseOutputListener extends CmdOutputListener
{
    public PerimeterDefenseOutputListener(VcaInfo vcaInfo)
    {
        super(vcaInfo);
    }
    ...
    public void json(Map eventInfoMap)
    {
        ...
        ReportDataEvent.queue(time, vcaInfo.getCamera(), new NoDataReport(vcaInfo.getInstanceId(), EventType.VCA_PERIMETER_DEFENSE));
    }
