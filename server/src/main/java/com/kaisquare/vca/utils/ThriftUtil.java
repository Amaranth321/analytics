...
public class ThriftUtil
{
     ...
     *                             client.
     */
    public static <T> Client<T> newServiceClient(Class<T> serviceIfaceClass,
                                                 Class<? extends T> serviceClientClass,
                                                 String serviceServerHost,
                                                 int serviceServerPort,
                                                 int socketTimeout) throws TTransportException
    {
    ...
    public static <T> Client<T> newServiceClient(Class<T> serviceIfaceClass,
                                                 ...
                                                 int socketTimeout,
                                                 int numTries,
                                                 int retryDelay) throws TTransportException
    {
     ...
     *                             client.
     */
    private static <T> InnerClient<T> instantiateClient(Class<T> serviceIfaceClass,
                                                        Class<? extends T> serviceClientClass,
                                                        String serviceServerHost,
                                                        int serviceServerPort,
                                                        int socketTimeout) throws TTransportException
